...
namespace NixCinemaSite.PL.Areas.Admin.Controllers
{
    ...
    {
        private readonly ICertificateService _presentationCertificateService;

        public CertificateController(ICertificateService presentationCertificateService)
        {
            _presentationCertificateService = presentationCertificateService;
        }
        // TODO фронт посмотреть варианты роута 
